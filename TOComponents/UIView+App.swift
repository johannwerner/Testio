...
public extension UIView {
    ...
    // MARK: - Wrap
    func wrap(view: UIView, offset: CGFloat = 0, toBottom: Bool = false) {
        wrap(view: view,
    ...
    func wrap(view: UIView,
        ...
        let viewBottom = toBottom ? bottomAnchor : safeAreaLayoutGuide.bottomAnchor
        addSubview(view)
        NSLayoutConstraint.activate([
            ...
            view.bottomAnchor.constraint(equalTo: viewBottom,
                                         constant: -verticalOffset)
        ])
    }

    func center(view: UIView, factor: CGFloat = 1) {
        center(view: view, heightFactor: factor,
               widthFactor: factor)
    }

    func center(view: UIView, with size: CGSize) {
        view.translatesAutoresizingMaskIntoConstraints = false
        addSubview(view)
        NSLayoutConstraint.activate([
    ...
    func center(view: UIView, heightFactor: CGFloat = 1, widthFactor: CGFloat = 1) {
        view.translatesAutoresizingMaskIntoConstraints = false
        addSubview(view)
        NSLayoutConstraint.activate([
            view.centerXAnchor.constraint(equalTo: centerXAnchor),
            view.centerYAnchor.constraint(equalTo: centerYAnchor),
            view.widthAnchor.constraint(equalTo: widthAnchor, multiplier: widthFactor),
            view.heightAnchor.constraint(equalTo: heightAnchor, multiplier: heightFactor)
        ])
    }
